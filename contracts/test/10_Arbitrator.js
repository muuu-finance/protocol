...
contract('Arbitrator Test', async (accounts) => {
  it('should move snx to arbitration when two pools try to claim', async () => {
    ...
    let susdGauge = await IKaglaGauge.at(
      '0xA90996896660DEcC6E997655E065b23788857849',
    )
    let eursGauge = await IKaglaGauge.at(
    ...
    await rewardFactory
      .activeRewardCount(snx.address)
      .then((a) => console.log('active snx rewards: ' + a))
    ...
    // await kgl.balanceOf(muKglRewards).then(a=>console.log("kgl at muKglRewards " +a));
    ...
    await snx
      .balanceOf(snxRewards.address)
      .then((a) => console.log('snx on spool rewards: ' + a))
    await snx
      .balanceOf(eursSnxRewards.address)
      .then((a) => console.log('snx on eurs rewards: ' + a))
    ...
    let snxcontract = await ISnxRewards.at(
      '0xc0d8994Cd78eE1980885DF1A0C5470fC977b5cFe',
    )
    ...
    await snx
      ...
      .then((a) => console.log('snx on eurs rewards: ' + a))
    await snx
      .balanceOf(arbitrator.address)
      .then((a) => console.log('snx arbitrator: ' + a))
    ...
    await rewardStash
      .tokenInfo()
      .then((a) => console.log('susd token info: ' + JSON.stringify(a)))
    await eursStash
      .tokenInfo(0)
      .then((a) => console.log('eurs token info: ' + JSON.stringify(a)))
    await snx
      .balanceOf(snxRewards.address)
      .then((a) => console.log('snx on spool rewards: ' + a))
    await snx
    ...
    await snx
      .balanceOf(rewardStash.address)
      .then((a) => console.log('snx on susd stash: ' + a))
    await snx
      .balanceOf(eursStash.address)
      .then((a) => console.log('snx on eurs stash: ' + a))
