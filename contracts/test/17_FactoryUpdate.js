...
contract('Factory Update', async (accounts) => {
  it('should update stash factory', async () => {
    ...
    await booster.addPool(rethLP.address, rethGauge.address, 3, {
      from: multisig,
      gasPrice: 0,
    })
    ...
    await stafi
      .balanceOf(info.stash)
      .then((a) => console.log('stafi on stash ' + a))
    ...
    await stafi
      ...
      .then((a) => console.log('stafi on proxy ' + a))
    ...
    await stafi
      .balanceOf(userA)
      .then((a) => console.log('stafi on user A ' + a))
    ...
    await weth
      ...
      .then((a) => console.log('weth on stash: ' + a))
    await weth
      .balanceOf(hook.address)
      .then((a) => console.log('weth on hook: ' + a))
    //earmark
    await booster.earmarkRewards(poolCount - 1)
    console.log('earmarked')
    await cvx
    ...
    await weth
      .balanceOf(hook.address)
      .then((a) => console.log('weth on hook after earmark: ' + a))
