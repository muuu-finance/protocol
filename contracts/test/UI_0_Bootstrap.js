...
contract('Bootstrap', async (accounts) => {
  it('should exchange for various LP tokens', async () => {
    ...
    await walletChecker
      .approveWallet(contractList.system.voteProxy, { from: checkerAdmin, gasPrice: 0 })
      .catch((a) => console.log('--> could not whitelist'));
    ...
    let pbtcswap = await I2KaglaFi.at('0x7F55DDe206dbAD629C080068923b36fe9D6bDBeF');
