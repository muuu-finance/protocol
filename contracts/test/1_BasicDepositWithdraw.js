...
contract('BasicDepositWithdraw', async (accounts) => {
  it('should test basic deposits and withdrawals', async () => {
    ...
    await threeKgl.balanceOf(userA).then((a) => console.log('wallet balance: ' + a));
    ...
    await voteproxy.balanceOfPool(threeKglGauge).then((a) => console.log('gauge balance: ' + a));
    ...
    await expectRevert(booster.withdraw(poolId, startingThreeKgl + 1, { from: userA }), 'revert');
    ...
    await threeKgl.balanceOf(userA).then((a) => console.log('userA wallet balance: ' + a));
    ...
    await threeKgl.balanceOf(userB).then((a) => console.log('userB wallet balance: ' + a));
