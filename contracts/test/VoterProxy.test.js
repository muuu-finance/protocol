...
contract("CurveVoterProxy", async accounts => {
  ...
  it("constructor & initial parameters", async () => {
    ...
    assert.equal(await instance.votingEscrow(), votingEscrow.address, "Fail to check .votingEscrow")
    assert.equal(await instance.mintr(), "0xd061D61a4d941c39E5453435B6345Dc261C2fcE0", "Fail to check .mintr")
    assert.equal(await instance.crv(), "0xD533a949740bb3306d119CC777fa900bA034cd52", "Fail to check .crv")
    assert.equal(await instance.gaugeController(), "0x2F50D538606Fa9EDD2B11E2446BEb18C9D5846bB", "Fail to check .gaugeController")
  })
